...
// 请填写您的AccessKeyId。
var accessKeyId string = "LTAI5tFc8pbqU7WyheF8LkdE"
// 请填写您的AccessKeySecret。
var accessKeySecret string = "MgRvwEIYecE7xnCe3t5atsmaSvM9gu"
// host的格式为 bucketname.endpoint ，请替换为您的真实信息。
var host string = "http://ceshixiaa2.oss-cn-hangzhou.aliyuncs.com"
// callbackUrl为 上传回调服务器的URL，请将下面的IP和Port配置为您自己的真实信息。
var callbackUrl string = "http://alr6la4off.52http.tech";
// 用户上传文件时指定的前缀。
